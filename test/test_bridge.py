...
if any(t["name"] == "ghidra_functions" for t in tools):
    ...
    print("--- ghidra_where(0x800eab30)")
    print(call("ghidra_where", address="0x800eab30"))
    print("--- ghidra_find(unnamed, region)")
    print(call("ghidra_find", unnamed=True, region="80000000-80ffffff", limit=2))
    print("--- _grep on xrefs")
    print(call("ghidra_xrefs", action="get_xrefs_to", args={"address": "0x50026c47", "_grep": "WRITE"})[:200])
    print("--- batch_decompile with a list arg")
    print(call("ghidra_functions", action="batch_decompile", args={"functions": ["0x800fa5c6"]})[:120])
